...
implementation. Bison presumably omits remergeable states by generating states in a different order,
but to my knowledge there is no tractable approach which universally eliminates remerging utility.
...
albeit at the cost of code clarity and maintainability. More critically, Hocc is implemented on top
