...
let to_hmi conf Parse.(Hmhi {prelude; hocc; postlude; eoi=Eoi {eoi}}) io _t =
  ...
  let hmi_path =
    Path.(join [Conf.dstdir conf; of_string (module_name ^ ".hmi")] |> to_string_replace) in
  let directive_pathstr = String.(hmhi_path |> to_string ~pretty:true) in
  let io =
    io.hmi
    |> Fmt.fmt "# This file was generated by `hocc`; edit "
    |> Fmt.fmt String.(hmhi_path |> to_string ~pretty:true)
    |> Fmt.fmt " rather than "
    |> Fmt.fmt String.(hmi_path |> to_string ~pretty:true)
    |> Fmt.fmt "\n"
...
let to_hm conf _hmh io _t =
  ...
  let io =
    io.hm
    |> Fmt.fmt "# This file was generated by `hocc`; edit "
    |> Fmt.fmt String.(module_name ^ ".hmh" |> to_string ~pretty:true)
    |> Fmt.fmt " rather than "
