...
val pare: 'a t -> base:usize -> past:usize -> 'a t
...
val swap_inplace: 'a t -> usize -> usize -> unit
(** Swap elements at given indices in place (mutate). *)

val swap: 'a t -> usize -> usize -> 'a t
...
val blit: 'a t -> usize -> 'a t -> usize -> usize -> unit
...
val psearch: ?base:usize -> ?past:usize -> 'a t -> 'a -> cmp:('a -> 'a -> Cmp.t)
  -> (Cmp.t * usize) option
...
val search: ?base:usize -> ?past:usize -> 'a t -> 'a -> cmp:('a -> 'a -> Cmp.t)
  -> usize option
...
val nsearch: ?base:usize -> ?past:usize -> 'a t -> 'a -> cmp:('a -> 'a -> Cmp.t)
  -> (Cmp.t * usize) option
