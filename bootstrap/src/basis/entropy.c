...
// The OCaml FFI is quite low-level, such that returning (Int64.t option) is a lot of trouble
// relative to returning an array. As a consequence this function returns an empty array to indicate
// error.
//
//                            nbits -> [|entropy...|]
