...
module UI16 = Convert.Make_nbU_nbI(T)(I16)
let bits_of_i16 = UI16.bits_of_x
let bits_to_i16 = UI16.bits_to_x
let like_of_i16_opt = UI16.like_of_x_opt
let like_to_i16_opt = UI16.like_to_x_opt
let like_of_i16_hlt = UI16.like_of_x_hlt
let like_to_i16_hlt = UI16.like_to_x_hlt
